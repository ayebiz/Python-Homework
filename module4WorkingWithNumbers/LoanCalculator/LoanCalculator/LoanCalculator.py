#Loan Calculator Homework for Module 4

loanAmt = input("Please tell me how much you wants for your loan? ")
print(int(loanAmt))
L = (int(loanAmt))
print(L)
interest = input("Please tell me what interest rate in percentage you are paying? ")
print(float(interest)/100)
i = (float(interest)/100)
print(i)
payments = input("Please let us know how long is your long in years? ")
print(int(payments)*12)
n = (int(payments)*12)
print(n)
#monthlyPay = ((L)*((i)*(1+(i))/(n))/((i)*(1+(i))/((n)-1)))
monthlyPay = (L)*((i)*(1+(i))*(n))/((1+(i))*((n)-1))
print(monthlyPay)
